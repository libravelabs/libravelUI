...
const circleVariants = cva('inline-block flex-shrink-0 rounded-full', {
    variants: {
        size: {
            xs: 'h-1.5 w-1.5',
            sm: 'h-2 w-2',
...
interface AnimatedCircleIndicatorProps extends VariantProps<
    typeof circleVariants
> {
