...
const groupVariants = cva(
    'inline-flex w-fit overflow-hidden border border-border bg-background',
    {
        variants: {
            orientation: {
                horizontal: 'flex-row',
...
const ToggleGroup = React.forwardRef<HTMLDivElement, ToggleGroupProps>(
    (
        { className, orientation = 'horizontal', size, radius, ...props },
        ref,
    ) => {
        return (
...
const itemVariants = cva(
    'relative inline-flex cursor-pointer items-center gap-1 font-medium transition-colors select-none focus-visible:z-10 focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
    {
        variants: {
            state: {
                default:
