                                        ...
                                        <CalendarCell
                                            ...
                                            className={({
                                                ...
                                                cn(
                                                    ...
                                                    isSelected &&
                                                        'bg-primary font-semibold text-primary-foreground! hover:bg-primary/70 focus-visible:ring-ring',
                                                    isDisabled &&
...
function SelectMonth({ state }: SelectMonthProps) {
    ...
    const months = Array.from(
        {
            length: state.focusedDate.calendar.getMonthsInYear(
                state.focusedDate,
            ),
        },
        (_, i) => {
        ...
        <SelectRoot
            ...
            onSelectionChange={(key) => {
                state.setFocusedDate(
                    state.focusedDate.set({ month: Number(key) }),
                );
            }}
        >
