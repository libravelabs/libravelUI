            ...
            {(values) => (
                <>
                    <span
                        data-slot="indicator"
                        className={cn(
                            'relative isolate inline-flex h-6 w-10 rounded-full p-[3px] transition duration-200 ease-in-out sm:h-5 sm:w-8',
                            'bg-secondary',
                            'inset-ring inset-ring-foreground/5',
                            'forced-colors:bg-[Highlight] forced-colors:outline',
                            values.isHovered &&
                                'inset-ring-foreground/15 dark:inset-ring-foreground/25',
                            values.isFocusVisible &&
                                'bg-primary/20 ring-2 ring-primary/20 inset-ring-primary/70 selected:inset-ring-primary/30',
                            values.isSelected &&
                                'bg-primary inset-ring-primary',
                            values.isDisabled &&
                                'dark:group-disabled:bg-muted dark:group-disabled:group-selected:bg-primary dark:group-disabled:group-selected:inset-ring-muted',
                        )}
                    >
                        <span
                            aria-hidden="true"
                            className={cn(
                                ...
                                values.isSelected &&
                                    'translate-x-4 shadow ring shadow-primary ring-primary group-disabled:shadow-sm group-disabled:ring-muted-foreground sm:translate-x-3',
                            )}
                        />
                    </span>
