    ...
    return (
        <TreeItemPrimitive
            className={composeTailwindRenderProps(className, [
                ...
                '**:data-[slot=avatar]:me-(--me-icon) **:data-[slot=avatar]:size-6 **:data-[slot=avatar]:*:me-1.5 **:data-[slot=avatar]:*:size-6 sm:**:data-[slot=avatar]:size-5 sm:**:data-[slot=avatar]:*:size-5',
...
function TreeIndicator({ values }: TreeIndicatorProps) {
    return (
        <Button
            ...
            isDisabled={values.isDisabled}
            className={cn(
                'size-5 shrink-0 cursor-pointer content-center text-muted-foreground hover:text-foreground',
