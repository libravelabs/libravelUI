...
const dropZoneVariants = cva(
    'group relative flex cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border text-sm transition-all duration-300 *:cursor-pointer focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none data-[disabled]:pointer-events-none data-[disabled]:text-muted-foreground',
    {
        variants: {
            tone: {
                default:
                    'border border-solid border-border bg-transparent shadow-sm hover:border-primary/30 hover:shadow-md',
                dashed: 'border-2 border-dashed border-border bg-transparent hover:border-primary/50 hover:bg-primary/10',
