        ...
        <TagPrimitive
            ...
            className={composeRenderProps(
                ...
                (
                    ...
                    cn(
                        'inline-flex cursor-default items-center gap-2 rounded-full px-2 py-0.5 text-sm/5 font-medium inset-ring inset-ring-border outline-hidden sm:text-xs/5 forced-colors:outline',
                        isSelected &&
                            'border-primary bg-primary/20 text-primary inset-ring-primary focus-visible:bg-primary/40',
                        isFocusVisible &&
                ...
                <>
                    ...
                    {allowsRemoving && (
                        <Button
                            slot="remove"
                            className={cn(
                                '-mx-0.5 grid size-3.5 shrink-0 place-content-center rounded-full bg-muted outline-hidden hover:opacity-70',
