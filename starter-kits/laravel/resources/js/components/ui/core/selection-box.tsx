  ...
  compoundVariants: [
    {
      ...
      columns: 1,
      className:
        "*:data-[slot=selectionbox-item]:-mt-px rounded-lg *:data-[slot=selectionbox-item]:inset-ring-1 *:data-[slot=selectionbox-item]:rounded-none *:data-[slot=selectionbox-item]:last:rounded-b-[calc(var(--radius-lg)-1px)] *:data-[slot=selectionbox-item]:first:rounded-t-[calc(var(--radius-lg)-1px)]",
    },
  ],
});
...
const selectionboxItemStyles = cva(
  [
    ...
    "inset-ring inset-ring-border rounded-lg p-4",
    ...
    variants: {
      ...
      highlighted: {
        true: [
          ...
          "inset-ring-ring/70 z-20 hover:bg-primary/30",
        ...
        const content = hasCustomChildren ? (
          ...
          <>
            ...
            <div className="flex flex-col">
              ...
              {description && (
                <SelectionboxDescription>{description}</SelectionboxDescription>
              )}
            </div>
          </>
        );
