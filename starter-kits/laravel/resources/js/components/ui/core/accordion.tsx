...
const accordionVariants = cva(
    'group peer w-full cursor-default disabled:cursor-not-allowed disabled:opacity-75',
    {
        variants: {
            tone: {
                default: 'overflow-hidden',
                ghost: '',
                outline: 'overflow-hidden rounded-xl border border-border',
                solid: 'overflow-hidden rounded-xl border bg-background shadow-sm',
                muted: 'overflow-hidden rounded-xl border border-border bg-muted/50',
                separated: '',
            },
            size: {
                sm: 'max-w-lg text-sm',
