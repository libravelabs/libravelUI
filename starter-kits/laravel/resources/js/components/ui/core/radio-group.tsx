            ...
            <>
                {(label || description) && (
                    <div>
                        ...
                        {description && (
                            <Description
                                className={cn(classNames?.description)}
                            >
                                {description}
                            </Description>
                        )}
                    ...
                    return (
                        ...
                        >
                            <span
                                data-slot="indicator"
                                className={cn(
                                    'relative isolate flex size-4.5 shrink-0 items-center justify-center rounded-full text-background inset-ring inset-ring-input sm:size-4',
                                    isSelected &&
                                        'bg-background inset-ring-ring',
                                    isFocusVisible &&
                                        'ring-3 ring-ring/20 inset-ring-ring',
                                    isInvalid &&
                                        'bg-destructive/5 text-destructive ring-destructive/20 inset-ring-destructive/70',
                                )}
                            >
                                <AnimatePresence>
                                    {isSelected && (
