                ...
                return (
                    <>
                        <div className="flex w-full justify-between gap-2">
                            ...
                            >
                                {percentage >= 80 && (
                                    <AlertCircle className="inline-block size-4 stroke-destructive align-text-bottom text-destructive" />
                                )}
                                {` ${valueText}`}
                            </span>
                        </div>
                        <div className="relative h-2 rounded-full bg-muted outline -outline-offset-1 outline-transparent">
                            <motion.div
                                className={cn(
