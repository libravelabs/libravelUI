    ...
    return (
        <TableContext.Provider value={{ allowResize, bleed }}>
            <div className="flow-root">
                <div
                    className={cn(
                        'relative -mx-4 overflow-x-auto whitespace-nowrap has-data-[slot=table-resizable-container]:overflow-auto',
                        className,
                    )}
                >
                    <div
    ...
    return (
        <ColumnResizerPrimitive
            ...
            className={composeTailwindRenderProps(
                className,
                '&[data-resizable-direction=left]:cursor-e-resize &[data-resizable-direction=right]:cursor-w-resize absolute end-0 top-0 bottom-0 grid w-px touch-none place-content-center px-1 data-[resizable-direction=both]:cursor-ew-resize [&[data-resizing]>div]:bg-primary',
            )}
        >
        ...
        <Column
            ...
            className={composeTailwindRenderProps(
                ...
                cn(
                    ...
                    'relative outline-hidden data-dragging:cursor-grabbing allows-sorting:cursor-pointer',
...
function TableRow<T extends object>({
    ...
    return (
        <Row
            ...
            className={composeRenderProps(
                ...
                (
                    ...
                    cn(
                        'group relative border-b text-muted-foreground ring-primary outline-transparent last:border-b-0',
                        ...
                        (props.href ||
                            ...
                            selectionMode === 'multiple') &&
                            isFocusVisibleWithin &&
                            'bg-secondary/50 text-foreground selected:bg-secondary/50',
        ...
        >
            {allowsDragging && (
                <TableCell className="max-w-4 sm:first:ps-1 sm:last:pe-1">
                    <Button
                        slot="drag"
            ...
            {selectionBehavior === 'toggle' && (
                <TableCell
                    className={cn(
                        !bleed && 'max-w-4 sm:first:ps-1 sm:last:pe-1',
                    )}
                >
                    <Checkbox slot="selection" />
                </TableCell>
    ...
    return (
        <Cell
            ...
            className={composeTailwindRenderProps(
                className,
                cn(
                    'group px-4 py-2 align-middle outline-hidden group-has-data-focus-visible-within:text-foreground first:ps-4 last:pe-4',
                    !bleed && 'sm:first:ps-1 sm:last:pe-1',
