...
const paginationItem = cva(
    'group relative inline-flex cursor-pointer items-center justify-center text-sm whitespace-nowrap transition-all focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
    {
        variants: {
            tone: {
                default:
                    'text-foreground hover:bg-accent hover:text-accent-foreground focus-visible:ring-ring data-[active=true]:text-primary-foreground',
                outline:
                    'text-muted-foreground/60 hover:bg-accent hover:text-accent-foreground focus-visible:ring-ring data-[active=true]:text-foreground',
                ghost: 'text-muted-foreground/60 hover:text-foreground focus-visible:ring-ring data-[active=true]:scale-125 data-[active=true]:text-foreground',
                secondary: 'text-secondary-foreground hover:opacity-70',
                link: 'underline-offset-4 hover:underline data-[active=true]:text-primary',
...
const paginationNav = cva(
    'inline-flex cursor-pointer items-center justify-center gap-2 px-3 text-sm whitespace-nowrap text-foreground transition-all hover:text-accent-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
    {
        variants: {
            tone: {
                default:
...
const activeVariants = cva('absolute inset-0 z-0 transition-none', {
    variants: {
        tone: {
            ...
            outline:
                'border-2 border-primary bg-transparent group-hover:opacity-70',
            secondary: 'bg-secondary group-hover:opacity-70',
            ghost: 'group-hover:bg-foreground/10',
            link: '',
            underline: '!rounded-none border-b-2 border-primary',
        },
        size: {
            sm: 'h-8',
            default: 'h-9',
