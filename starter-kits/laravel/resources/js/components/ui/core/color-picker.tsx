...
function ColorPicker({
    ...
    return (
        <div
            className={cn(
                'flex max-w-3xs flex-col items-start gap-y-1',
                className,
            )}
        >
                ...
                {children ?? (
                    <Popover {...popover}>
                        <PopoverTrigger
                            ...
                            iconOnly={!label}
                            className={cn(
                                'w-full px-2.5 *:data-[slot=color-swatch]:-mx-0.5 *:data-[slot=color-swatch]:size-5',
                                'inset-ring inset-ring-input',
                                'focus:ring-3 focus:ring-ring/20 focus:inset-ring-ring/70',
                                'data-[state=open]:ring-3 data-[state=open]:ring-ring/20 data-[state=open]:inset-ring-ring/70',
