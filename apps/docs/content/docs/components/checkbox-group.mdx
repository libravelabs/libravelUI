...
<Info title="Standalone Checkbox Component">If you're looking for a single checkbox component that can be used independently, including support for labels, descriptions, and validation, see: [Checkbox](/docs/components/checkbox)</Info>
