...
<Info title="Grouping Multiple Checkboxes">
  ...
  Group](/docs/components/checkbox-group)
</Info>

## Basic

<Playground comp="checkbox/basic" />
...
<Playground comp="checkbox/sizes" />
...
<Playground comp="checkbox/with-desc" />
...
<Playground comp="checkbox/with-error" />
