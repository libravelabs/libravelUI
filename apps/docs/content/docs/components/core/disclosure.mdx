...
<Playground comp="disclosure/basic" />
...
The **Disclosure** component provides several tones to display different style.

<Playground comp="disclosure/tones" demo="disclosure/tones.demo" />
