...
The Accordion component offers visual tones like `default`, `ghost`, `outline`, `solid`, `muted`, and `separated` for different use cases.

<Playground comp="accordion/tones" demo="accordion/tones.demo" />
