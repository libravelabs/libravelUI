...
<Playground comp="toggle-group/basic" demo="toggle-group/basic.demo" />
...
Arrange toggle buttons in a vertical layout to save horizontal space and create a clear, stacked structure for grouped options.

<Playground comp="toggle-group/vertical" />

### Sizes

Support multiple toggle group sizes to fit different design contexts and improve accessibility across devices.

<Playground comp="toggle-group/sizes" />
...
<Playground comp="toggle-group/controlled" />
