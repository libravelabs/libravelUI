...
<Info>If you're looking for how to group multiple checkboxes together under a shared label or manage them as a single form field, see: [Checkbox Group](/docs/components/checkbox-group)</Info>
