  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=float]/navbar:overflow-y-hidden peer-data-[variant=inset]/navbar:m-2 peer-data-[variant=inset]/navbar:-mt-3 peer-data-[variant=inset]/navbar:rounded-xl peer-data-[variant=inset]/navbar:bg-background",
        className,
      )}
      {...props}
    />
