...
interface ColorFieldProps extends ColorFieldPrimitiveProps, InputProps {
  preview?: boolean;
  colorPicker?: boolean;
}
...
function ColorInput({
  ...
  return (
    ...
    >
      <Input
        className={cn("pe-1.5", classNames?.input)}
...
function ColorPicker({
  ...
  return (
    <div className={cn("flex flex-col items-start gap-y-1", className)}>
